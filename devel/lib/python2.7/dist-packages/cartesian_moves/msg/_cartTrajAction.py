"""autogenerated by genpy from cartesian_moves/cartTrajAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import cartesian_moves.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class cartTrajAction(genpy.Message):
  _md5sum = "6772530a311c1d576a37e156463bc006"
  _type = "cartesian_moves/cartTrajAction"
...
"""
  ...
  _slot_types = ['cartesian_moves/cartTrajActionGoal','cartesian_moves/cartTrajActionResult','cartesian_moves/cartTrajActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = cartesian_moves.msg.cartTrajActionGoal()
      if self.action_result is None:
        self.action_result = cartesian_moves.msg.cartTrajActionResult()
      if self.action_feedback is None:
        self.action_feedback = cartesian_moves.msg.cartTrajActionFeedback()
    else:
      self.action_goal = cartesian_moves.msg.cartTrajActionGoal()
      self.action_result = cartesian_moves.msg.cartTrajActionResult()
      self.action_feedback = cartesian_moves.msg.cartTrajActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i4d3I.pack(_x.action_goal.goal.traj_id, _x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.z, _x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_result.result.return_val, _x.action_result.result.traj_id, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.traj_id, _x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.z, _x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i4d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.return_val, _x.action_result.result.traj_id, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
_struct_i4d3I = struct.Struct("<i4d3I")
