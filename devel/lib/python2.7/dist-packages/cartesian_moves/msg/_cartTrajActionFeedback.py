"""autogenerated by genpy from cartesian_moves/cartTrajActionFeedback.msg. Do not edit."""
import sys
...
class cartTrajActionFeedback(genpy.Message):
  ...
  _type = "cartesian_moves/cartTrajActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cartesian_moves/cartTrajFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = cartesian_moves.msg.cartTrajFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cartesian_moves.msg.cartTrajFeedback()
