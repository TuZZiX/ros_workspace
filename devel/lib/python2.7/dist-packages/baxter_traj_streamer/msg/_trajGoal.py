"""autogenerated by genpy from baxter_traj_streamer/trajGoal.msg. Do not edit."""
import sys
...
class trajGoal(genpy.Message):
  _md5sum = "795a47f183c47120e2bd82737a4d2a43"
  _type = "baxter_traj_streamer/trajGoal"
...
"""
  __slots__ = ['trajectory','traj_id']
  _slot_types = ['trajectory_msgs/JointTrajectory','int32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_i.pack(self.traj_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.traj_id,) = _struct_i.unpack(str[start:end])
      return self
