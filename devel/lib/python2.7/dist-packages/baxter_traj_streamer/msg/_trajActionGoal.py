"""autogenerated by genpy from baxter_traj_streamer/trajActionGoal.msg. Do not edit."""
import sys
...
class trajActionGoal(genpy.Message):
  _md5sum = "39105c9ddfcdfce0b589fb95b4dc0284"
  _type = "baxter_traj_streamer/trajActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','baxter_traj_streamer/trajGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = baxter_traj_streamer.msg.trajGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = baxter_traj_streamer.msg.trajGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_i.pack(self.goal.traj_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.traj_id,) = _struct_i.unpack(str[start:end])
      return self
