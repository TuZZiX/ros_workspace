"""autogenerated by genpy from robot_simulator/TrajMsgAction.msg. Do not edit."""
import sys
...
import robot_simulator.msg

class TrajMsgAction(genpy.Message):
  _md5sum = "c95c0771e1abad305afdfe3f85608917"
  _type = "robot_simulator/TrajMsgAction"
...
"""
  ...
  _slot_types = ['robot_simulator/TrajMsgActionGoal','robot_simulator/TrajMsgActionResult','robot_simulator/TrajMsgActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajMsgAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robot_simulator.msg.TrajMsgActionGoal()
      if self.action_result is None:
        self.action_result = robot_simulator.msg.TrajMsgActionResult()
      if self.action_feedback is None:
        self.action_feedback = robot_simulator.msg.TrajMsgActionFeedback()
    else:
      self.action_goal = robot_simulator.msg.TrajMsgActionGoal()
      self.action_result = robot_simulator.msg.TrajMsgActionResult()
      self.action_feedback = robot_simulator.msg.TrajMsgActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_result.result.progress, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.progress, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
