"""autogenerated by genpy from robot_simulator/TrajMsgActionGoal.msg. Do not edit."""
import sys
...
class TrajMsgActionGoal(genpy.Message):
  _md5sum = "a99e83ef6185f9fdd7693efe99623a86"
  _type = "robot_simulator/TrajMsgActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','robot_simulator/TrajMsgGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajMsgActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = robot_simulator.msg.TrajMsgGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = robot_simulator.msg.TrajMsgGoal()
