"""autogenerated by genpy from example_trajectory/TrajActionMsgActionGoal.msg. Do not edit."""
import sys
...
class TrajActionMsgActionGoal(genpy.Message):
  _md5sum = "a99e83ef6185f9fdd7693efe99623a86"
  _type = "example_trajectory/TrajActionMsgActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','example_trajectory/TrajActionMsgGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajActionMsgActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = example_trajectory.msg.TrajActionMsgGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = example_trajectory.msg.TrajActionMsgGoal()
