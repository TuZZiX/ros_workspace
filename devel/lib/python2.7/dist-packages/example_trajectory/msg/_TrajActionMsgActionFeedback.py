"""autogenerated by genpy from example_trajectory/TrajActionMsgActionFeedback.msg. Do not edit."""
import sys
...
class TrajActionMsgActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "example_trajectory/TrajActionMsgActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','example_trajectory/TrajActionMsgFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajActionMsgActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = example_trajectory.msg.TrajActionMsgFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = example_trajectory.msg.TrajActionMsgFeedback()
