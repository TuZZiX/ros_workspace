"""autogenerated by genpy from my_commander/commandAction.msg. Do not edit."""
import sys
...
class commandAction(genpy.Message):
  _md5sum = "91ff0d7c2a9226753b4c235142de87f4"
  _type = "my_commander/commandAction"
...
"""
  ...
  _slot_types = ['my_commander/commandActionGoal','my_commander/commandActionResult','my_commander/commandActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(commandAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = my_commander.msg.commandActionGoal()
      if self.action_result is None:
        self.action_result = my_commander.msg.commandActionResult()
      if self.action_feedback is None:
        self.action_feedback = my_commander.msg.commandActionFeedback()
    else:
      self.action_goal = my_commander.msg.commandActionGoal()
      self.action_result = my_commander.msg.commandActionResult()
      self.action_feedback = my_commander.msg.commandActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d4I.pack(_x.action_goal.goal.amplitude, _x.action_goal.goal.frequency, _x.action_goal.goal.cycles, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4I.pack(_x.action_result.result.total_cycle, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.amplitude, _x.action_goal.goal.frequency, _x.action_goal.goal.cycles, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2d4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.total_cycle, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
