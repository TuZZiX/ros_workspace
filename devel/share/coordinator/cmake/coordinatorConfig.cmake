...
if("TRUE" STREQUAL "TRUE")
  set(coordinator_SOURCE_PREFIX /media/psf/Programming/ros_ws/src/cwru_baxter/coordinator)
  set(coordinator_DEVEL_PREFIX /media/psf/Programming/ros_ws/devel)
  ...
  set(coordinator_INSTALL_PREFIX /media/psf/Programming/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'coordinator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/psf/Programming/ros_ws/src/cwru_baxter/coordinator/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
...
set(depends "roscpp;std_msgs;geometry_msgs;cwru_srv;sensor_msgs;tf")
