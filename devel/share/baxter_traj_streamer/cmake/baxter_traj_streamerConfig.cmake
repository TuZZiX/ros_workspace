...
if(baxter_traj_streamer_CONFIG_INCLUDED)
  return()
endif()
set(baxter_traj_streamer_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'baxter_traj_streamer' is deprecated")
...
if(NOT "/home/tianshipei/ros_ws/devel/include;/home/tianshipei/ros_ws/src/cwru_baxter/baxter_traj_streamer/include " STREQUAL " ")
  set(baxter_traj_streamer_INCLUDE_DIRS "")
  set(_include_dirs "/home/tianshipei/ros_ws/devel/include;/home/tianshipei/ros_ws/src/cwru_baxter/baxter_traj_streamer/include")
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${baxter_traj_streamer_DIR}/../../../include" ABSOLUTE)
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND baxter_traj_streamer_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(baxter_traj_streamer_LIBRARY_DIRS ${lib_path})
      list(APPEND baxter_traj_streamer_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'baxter_traj_streamer'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND baxter_traj_streamer_LIBRARIES ${lib})
    endif()
  endif()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 baxter_traj_streamer_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${baxter_traj_streamer_dep}_FOUND)
      find_package(${baxter_traj_streamer_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${baxter_traj_streamer_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(baxter_traj_streamer_INCLUDE_DIRS ${${baxter_traj_streamer_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(baxter_traj_streamer_LIBRARIES ${baxter_traj_streamer_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${baxter_traj_streamer_dep}_LIBRARIES})
  _list_append_deduplicate(baxter_traj_streamer_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(baxter_traj_streamer_LIBRARIES ${baxter_traj_streamer_LIBRARIES})

  _list_append_unique(baxter_traj_streamer_LIBRARY_DIRS ${${baxter_traj_streamer_dep}_LIBRARY_DIRS})
