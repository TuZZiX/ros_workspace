...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_controllers_SOURCE_PREFIX /media/psf/Programming/ros_ws/src/external_packages/dynamixel_motor/dynamixel_controllers)
  set(dynamixel_controllers_DEVEL_PREFIX /media/psf/Programming/ros_ws/devel)
  ...
  set(dynamixel_controllers_INSTALL_PREFIX /media/psf/Programming/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dynamixel_controllers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'An Zhigang <anzhg@icloud.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dynamixel_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/psf/Programming/ros_ws/src/external_packages/dynamixel_motor/dynamixel_controllers/${idir}'.  Ask the maintainer 'An Zhigang <anzhg@icloud.com>' to fix it.")
    endif()
