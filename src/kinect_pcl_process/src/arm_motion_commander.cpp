...
bool ArmMotionCommander::moveArmsBack(void) {
...
bool ArmMotionCommander::planPath(geometry_msgs::PoseStamped pose) {
...
bool ArmMotionCommander::planPath(Eigen::VectorXd joints) {
	ROS_INFO("requesting a joint-space motion plan");
...
bool ArmMotionCommander::planPath(Eigen::Vector3d dp_displacement) {
...
bool ArmMotionCommander::executePath(double timeout) {
...
Eigen::VectorXd ArmMotionCommander::getJointAngles(void) {
...
geometry_msgs::PoseStamped ArmMotionCommander::getGripperPose(void) {
...
void ArmMotionCommander::convToPose(std::vector<geometry_msgs::PoseStamped> &pose_seq, std::vector<Eigen::Vector3f> &position_seq, Eigen::Quaterniond &orientation) {
